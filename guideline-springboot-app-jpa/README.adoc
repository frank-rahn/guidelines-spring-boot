...
** Schreiben eines Audit-Log durch https://hibernate.org/orm/envers/[Hibernate Envers] per https://spring.io/projects/spring-data-envers[Spring Data Envers] als eine Erweiterung von https://spring.io/projects/spring-data-jpa[Spring Data JPA]
